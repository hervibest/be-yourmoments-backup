...
func (mr *MockCacheAdapterMockRecorder) Del(ctx interface{}, keys ...interface{}) *gomock.Call {
...
func (m *MockCacheAdapter) Set(ctx context.Context, key string, value interface{}, expiration time.Duration) error {
	m.ctrl.T.Helper()
