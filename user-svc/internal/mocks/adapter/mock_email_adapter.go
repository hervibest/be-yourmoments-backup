...
//
//	mockgen -source=./adapter/email_adapter.go -destination=./mocks/adapter/mock_email_adapter.go -package=mockadapter
//
...
func (mr *MockEmailAdapterMockRecorder) SendEmail(email, token, category any) *gomock.Call {
