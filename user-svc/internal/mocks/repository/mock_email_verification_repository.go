...
//
//	mockgen -source=./repository/email_verification_repository.go -destination=./mocks/repository/mock_email_verification_repository.go -package=mockrepository
//
...
func (mr *MockEmailVerificationRepositoryMockRecorder) Delete(ctx, tx, emailVerification any) *gomock.Call {
...
func (mr *MockEmailVerificationRepositoryMockRecorder) FindByEmail(ctx, email any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEmailVerificationRepositoryMockRecorder) FindByEmailAndToken(ctx, email, token any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEmailVerificationRepositoryMockRecorder) Insert(ctx, tx, emailVerification any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockEmailVerificationRepositoryMockRecorder) Update(ctx, tx, emailVerification any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
